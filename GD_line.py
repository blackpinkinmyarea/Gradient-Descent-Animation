...
def gradientient_descent(x_init, learning_rate, iteration):
	x_list = [x_init]
	m = A.shape[0]
...
x_list = gradientient_descent(x_init, learning_rate, iteration)
...
line_ani = animation.FuncAnimation(fig1, update_for_line, iters, interval=50, blit=True)
